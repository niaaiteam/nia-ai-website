  ...
  return (
    <section ref={statusRef} className="py-8 bg-white border-y border-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className={`mt-12 max-w-2xl mx-auto transition-all duration-1000 delay-300 ${statusVisible ? 'animate-scale-in' : 'opacity-0'}`}>
          <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-6 animate-float">
...
const IndustrySection = () => {
  ...
  return (
    <section ref={industryRef} className="py-20 bg-nia-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${industryVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-8 gap-4">
          {industries.map((industry, index) => (
            <div
              key={industry}
              className={`bg-white rounded-lg p-4 text-center hover:shadow-lg transition-all cursor-pointer group duration-500 delay-${index * 50} ${industryVisible ? 'animate-scale-in' : 'opacity-0'}`}
            >
...
const FeaturesSection = () => {
  ...
  return (
    <section id="features" ref={featuresRef} className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${featuresVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
  ...
  return (
    <section ref={demoRef} className="py-20 bg-gradient-to-br from-nia-purple to-nia-teal">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-12 transition-all duration-1000 ${demoVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
...
const HowItWorksSection = () => {
  ...
  return (
    <section id="how-it-works" ref={worksRef} className="py-20 bg-nia-bg-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${worksVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
...
const StatsSection = () => {
  ...
  return (
    <section ref={statsRef} className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className={`text-center mb-16 transition-all duration-1000 ${statsVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
